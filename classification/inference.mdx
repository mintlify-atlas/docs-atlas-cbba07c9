...
description: "Run Bonnet weed segmentation on image directories via predict.py, or live webcam and video segmentation via real-time.py at approximately 2.5 fps."
---
